...
export function ProjectsPage() {
  ...
  const projects = t.raw('items').map((item: { id: string; title: string; desc: string; metrics: string[]; images: string[]; tech: Array<{ emoji: string; label: string }>; demo: string; github: string }) => ({
    id: item.id,
    title: item.title,
    images: item.images,
    desc: item.desc,
