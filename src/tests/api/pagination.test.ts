...
describe('Pagination Logic', () => {
  ...
  it('should return correct number of items for first page', () => {
    const result = paginateData(mockProjects, 3, null, 'created_at', 'desc');
  ...
  it('should return correct items for second page', () => {
    const firstPage = paginateData(mockProjects, 3, null, 'created_at', 'desc');
    const secondPage = paginateData(mockProjects, 3, firstPage.nextCursor!, 'created_at', 'desc');
  ...
  it('should return correct items for last page', () => {
    const result = paginateData(mockProjects, 3, createCursor(9, 'created_at', 'desc'), 'created_at', 'desc');
  ...
  it('should handle search filtering', () => {
    ...
    const result = paginateData(filteredData, 5, null, 'created_at', 'desc');
  ...
  it('should handle empty data', () => {
    const result = paginateData([], 5, null, 'created_at', 'desc');
  ...
  it('should handle limit larger than data', () => {
    const result = paginateData(mockProjects, 20, null, 'created_at', 'desc');
